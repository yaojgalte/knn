...
Pregnancies = int(st.text_input("Gravidity (the number of times that a woman has been pregnant)."))
Glucose = int(st.text_input("Glucose"))
BloodPressure = int(st.text_input("BloodPressure"))
SkinThickness = int(st.text_input("SkinThickness"))
Insulin = int(st.text_input("Insulin"))
BMI = float(st.text_input("BMI"))
DiabetesPedigreeFunction = float(st.text_input("DiabetesPedigreeFunction"))
